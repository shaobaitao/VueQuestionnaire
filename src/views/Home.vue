            ...
            <div class="form_item" v-for="(item,index) in formData" :key="index">
                ...
                <div class="item-bottom">
                    <div class="process-box pull-left">
                        ...
                        <el-link type="primary" icon="el-icon-s-promotion" @click="sendForm(item.exam_id)">发送问卷
                        </el-link>
                        <el-link type="primary" icon="el-icon-s-data" @click="analysisForm(item.exam_id)">成绩&数据
                        </el-link>
                    </div>
